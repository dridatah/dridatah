...
export default function ContactSection() {
  ...
  const activeSection = useSelector(
    (state) => state.global.home_five_active_section
  );
  return (
    <section
      className={`main-content-wrapper hm5-box contact_box ${
      ...
      <div className="hm5-contact-section">
        <div className="container-1660">
            ...
            <div className="col-xl-6">
              <div className="contact-info">
                ...
                >
                  ...
                  curabitur etiam nisl montes, gravida luctus nec morbi
                  dignissim ridiculus nam hendrerit ullamcorper, euismod
                </p>
          ...
          <div className="hm5-map-box position-relative mt-120">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2512.098979857154!2d7.525950276920745!3d50.97736104928544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47bec82ce946b679%3A0xb9d62e4ae5b6a1b3!2sBerlinstra%C3%9Fe%2C%2051645%20Gummersbach%2C%20Germany!5e0!3m2!1sen!2sbd!4v1687846796236!5m2!1sen!2sbd"
              style={{ border: 0 }}
              allowFullScreen=""
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
            ></iframe>
            <button className="pin-btn position-absolute start-50 top-50 translate-middle rounded-circle d-flex align-items-center justify-content-center">
