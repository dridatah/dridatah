...
export default function InnerTestimonial() {
  // Prev arrow
  ...
  return (
    <div className="hm5-feedback-section position-relative z-1 overflow-hidden" id="feedback">
      <span className="circle-shape-1 position-absolute z--1 rounded-circle"></span>
      <div className="container-1660">
        <div className="row">
          <div className="col-xl-6">
            <div className="section-title">
              <span className="cr-subtitle fw-semibold text-white position-relative">Our Testimonial</span>
