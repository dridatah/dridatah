    ...
    <section className="cr-about-section ptb-100 overflow-hidden">
      <div className="container">
        <div className="row">
          <div className="col-xl-6">
            <div className="section-title">
              <span className="cr-subtitle position-relative primary-text-color fw-semibold">Our Team Mates</span>
              <h2 className="mt-4 mb-60">About Create <span className="primary-text-color primary-bg-light px-2">Agency</span></h2>
            </div>
          </div>
        </div>
        ...
        <div className="tab-content mt-5">
          <div suppressHydrationWarning className="tab-pane fade show active" id="about">
            <div className="row g-5 align-items-center">
              <div className="col-xl-6">
                <div className="img-left">
                  <Image src="/assets/images/home-2/ab-1.jpg" alt="not found" className="img-fluid rounded-4" width={940} height={750} />
                </div>
              </div>
              <div className="col-xl-6">
                <div className="tab-content-right mx-532">
                  ...
                  <h3 className="mb-32 mt-4">We Build Software Solutions For Big Industries</h3>
                  <p className="mb-5">Cras facilisi fringilla nisi sed eget vel quis sollicitudin sagittis. Hendrerit metus nost magna interdum cum habitant sodales, sollicitudin tincidunt consequat lacinia ullamcorper enim aptent</p>
                  <div className="d-flex align-items-center gap-4 flex-wrap flex-sm-nowrap">
                    <Link href="/about" className="template-btn primary-btn">Learn More</Link>
                    <a href="tel:25259214893" className="phone-btn">
                      ...
                      <div>
                        <h5 className="mb-1 fw-semibold fs-20">+25 (259) 214893-23</h5>
                  ...
                  <div className="d-flex align-items-center cr-tab-counter mt-40 flex-wrap flex-sm-nowrap">
                    <div className="cr-tab-counter-single">
                      ...
                      <h6 className="fw-medium mb-0 fs-20">Years on the market</h6>
                    </div>
                    <div className="cr-tab-counter-single">
                      <h3 className="fw-semibold primary-text-color mb-0">
                      ...
                      <h6 className="fw-medium mb-0 fs-20">Projects delivered so far</h6>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row g-5">
              ...
              <div className="col-xl-6">
                <div className="tab-content-right mx-532">
                  ...
                  <div className="d-flex align-items-center cr-tab-counter mt-40 flex-wrap flex-sm-nowrap">
                    <div className="cr-tab-counter-single">
                      <h3 className="fw-semibold primary-text-color mb-0"><span className="counter">25</span><span>+</span></h3>
                      <h6 className="fw-medium mb-0 fs-20">Years on the market</h6>
                    </div>
                    <div className="cr-tab-counter-single">
                      <h3 className="fw-semibold primary-text-color mb-0"><span className="counter">375</span><span>+</span></h3>
                      <h6 className="fw-medium mb-0 fs-20">Projects delivered so far</h6>
                    </div>
                  </div>
                </div>
