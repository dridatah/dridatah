      ...
      <div className="sidebar-widget contact-widget mt-32 primary-bg-color">
        ...
        <div className="sidebar-icon-box">
          ...
          <div>
            ...
            <a href="tel:2869852156">
              <h6 className="mb-0 text-white fs-18">+286 985 2156</h6>
            </a>
          </div>
        </div>
        <div className="sidebar-icon-box mt-20">
          ...
          <div>
            ...
            <a href="mailto:info@dridatah.com">
              <h6 className="mb-0 text-white fs-18">info@dridatah.com</h6>
            </a>
          </div>
        </div>
        <div className="sidebar-icon-box mt-20">
          ...
          <div>
            ...
            <a href="tel:2869852156">
              <h6 className="mb-0 text-white fs-18">125 Berlin, Germany</h6>
            </a>
          </div>
        </div>
      </div>
