...
export default function ContactSection() {
  return (
    <section className="contact-section ptb-100 position-relative z-1 overflow-hidden hm3-light-bg" id="contact">
      <div className="container">
        <div className="row align-items-center g-5">
          <div className="col-xl-6">
            <div className="contact-info">
              <span suppressHydrationWarning className="cr-subtitle primary-text-color position-relative fw-semibold wow fadeInUp d-inline-block">Appointment</span>
              <h2 suppressHydrationWarning className="mb-4 mt-4 wow fadeInUp" data-wow-delay="0.2s">Let's <br /><span className="primary-text-color primary-bg-light px-1 text-italic fw-normal">Work Together</span></h2>
              ...
              <ul className="contact-info-list mt-5">
                <li suppressHydrationWarning className="d-flex align-items-center gap-4 wow fadeInUp" data-wow-delay="0.1s">
                  ...
                  <div>
                    <span className="fw-medium fs-xl primary-text-color">Mail Us</span>
                ...
                <li suppressHydrationWarning className="d-flex align-items-center gap-4 wow fadeInUp" data-wow-delay="0.2s">
                  ...
                  <div>
                    <span className="fw-medium fs-xl primary-text-color">Cal Us</span>
                ...
                <li suppressHydrationWarning className="d-flex align-items-center gap-4 wow fadeInUp" data-wow-delay="0.3s">
                  ...
                  <div>
                    <span className="fw-medium fs-xl primary-text-color">Address</span>
