...
import InnerBrandSection from './InnerBrandSection'

export default function DreamNdBrandSection() {
  return (
    <section className="dreamer-section pt-100 overflow-hidden position-relative z-1">
      <span className="layer-blur position-absolute z--1"></span>
