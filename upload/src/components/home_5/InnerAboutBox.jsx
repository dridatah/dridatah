    ...
    <div className="row g-5 align-items-center">
      <div className="col-xxl-5 col-xl-6">
        <div className="hm5-about-left">
          <Image
            src="/assets/images/home-5/ab-1.jpg"
            alt="not found"
            width={856}
            height={900}
            className="img-fluid"
      ...
      <div className="col-xxl-7 col-xl-6">
        <div className="hm5-about-right">
          ...
          <p className="fw-medium mb-60 mt-5">
            Continually utilize 24/365 bandwidth before real-time interfaces
            grow team core competencies with pandemic commerce. Objectively
            initiate pandemic users with deliver bricks clicks meta services for
            bricks and clicks innovation streamline front end aradigms expedite
            granular human capital rather than intuitive testing procedures
          </p>
